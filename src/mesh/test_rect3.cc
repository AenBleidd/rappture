...
static double xpts[2] = {
	0.9,
	2.19
};

static double ypts[5] = {
	3.0,
	3.2,
	3.5,
	7.9,
...
int main()
{
	...
	const char* gname2 = "output.mesh(m3d)";
	...
	RpGrid3dRect * mesh = new RpGrid3dRect(gname2);
	mesh->addAllPointsX(xpts, 2);
	mesh->addAllPointsY(ypts, 5);
	mesh->addAllPointsZ(zpts, 2);
	...
	RpGrid3d* g2ptr = (RpGrid3d*) newvis.getObject(gname2);
	g2ptr->print();

...
class RpEntityRef
{
    public:
         ...
         *   TranslateEntityRefs  --
         *
         *       Translate entity references and character references
         *       in the string "z".  "z" is overwritten with the 
         *       translated sequence.
         *
        ...
        static void TranslateEntityRefs (   char *z, 
                                            int  *newLen);

        static void appendEscaped (     std::string& value,
                                        std::string& retStr );

        RpEntityRef ()
        {
            // bErNeedsInit = 1;
            // apErHash array values should be set to zero by default?
        };

 ...
 *
 *    [basisHandle,err] = rpGetBasis(unitHandle)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [basisHandle,err] = rpGetBasis(unitHandle)
...
DEFUN_DLD (rpGetBasis, args, ,
"-*- texinfo -*-\n\
[basisHandle,err] = rpGetBasis(@var{unitHandle})\n\
\n\
Retrieve the basis of the Rappture Units object with the handle \n\
'unitHandle'. Return the handle of the basis if it exists. If there \n\
is no basis, then return a negative integer.\n\
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpGetBasis";

 ...
 *
 *    [err] = rpPutStringId(libHandle,path,value,id,append)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [err] = rpPutStringId (libHandle,path,value,id,append)
...
DEFUN_DLD (rpPutStringId, args, ,
"-*- texinfo -*-\n\
[err] = rpPutStringId(@var{libHandle},@var{path},@var{value},@var{id},@var{append})\n\
\n\
...
{
    static std::string who = "rpPutStringId";

 ...
 *
 *    [retStr,err] = rpGetUnitsName(unitHandle)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpGetUnitsName(unitHandle)
...
DEFUN_DLD (rpGetUnitsName, args, ,
"-*- texinfo -*-\n\
[retVal,err] = rpGetUnitsName(@var{unitHandle})\n\
\n\
Retrieve the unit and exponent of the Rappture Units object with \n\
the handle 'unitHandle'.\n\
Return the unit and exponent as one concatinated string.\n\
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpGetUnitsName";

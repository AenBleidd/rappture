 ...
 *
 *    [err] = rpPutDoubleId(libHandle,path,value,id,append)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [err] = rpPutDoubleId (libHandle,path,value,id,append)
...
DEFUN_DLD (rpPutDoubleId, args, ,
"-*- texinfo -*-\n\
[err] = rpPutDoubleId(@var{libHandle},@var{path},@var{value},@var{id},@var{append})\n\
\n\
...
{
    static std::string who = "rpPutDoubleId";

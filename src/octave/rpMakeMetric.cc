...
/**********************************************************************/
// METHOD: [err] = rpMakeMetric(basisHandle)
...
DEFUN_DLD (rpMakeMetric, args, ,
"-*- texinfo -*-\n\
[err] = rpMakeMetric(@var{basisHandle})\n\
\n\
Create the metric extensions for the Rappture Unit, referenced \n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpMakeMetric";

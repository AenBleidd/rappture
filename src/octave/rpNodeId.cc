 ...
 *
 *    [retStr,err] = rpNodeId(nodeHandle)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpNodeId(nodeHandle)
...
DEFUN_DLD (rpNodeId, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpNodeId(@var{nodeHandle})\n\
\n\
This method returns the id name of the node represented \n\
by @var{nodeHandle}.\n\
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpNodeId";

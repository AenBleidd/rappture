 ...
 *
 *    [retStr,err] = rpLibElementAsObject(libHandle,path)
 *
 * ======================================================================
...
DEFUN_DLD (rpLibElementAsObject, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpLibElementAsObject(@var{libHandle},@var{path})\n\
\n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpLibElementAsObject";

 ...
 *
 *    [unitHandle,err] = rpFind(unitSymbol)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [unitHandle,err] = rpFind(unitSymbol)
...
DEFUN_DLD (rpFind, args, ,
"-*- texinfo -*-\n\
[unitHandle,err] = rpFind(@var{unitSymbol})\n\
\n\
This method searches the Rappture Units Dictionary for the\n\

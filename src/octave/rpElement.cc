 ...
 *
 *    [retStr,err] = rpElement(libHandle,path)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpElement(libHandle,path)
...
DEFUN_DLD (rpElement, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpElement(@var{libHandle},@var{path})\n\
\n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpElement";

 ...
 *
 *    [err] = rpPutDouble(libHandle,path,value,append)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [err] = rpPutDouble (libHandle,path,value,append)
...
DEFUN_DLD (rpPutDouble, args, ,
"-*- texinfo -*-\n\
[err] = rpPutDouble(@var{libHandle},@var{path},@var{value},@var{append})\n\
\n\
...
{
    static std::string who = "rpPutDouble";

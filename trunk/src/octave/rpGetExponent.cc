 ...
 *
 *    [retVal,err] = rpGetExponent(unitHandle)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retVal,err] = rpGetExponent(unitHandle)
...
DEFUN_DLD (rpGetExponent, args, ,
"-*- texinfo -*-\n\
[retVal,err] = rpGetExponent(@var{unitHandle})\n\
\n\
Retrieve the exponent of the Rappture Units object with the handle \n\
'unitHandle'. Return the exponent as a double.\n\
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpGetExponent";

 ...
 *
 *    [retStr,err] = rpElementAsComp(libHandle,path)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpElementAsComp(libHandle,path)
...
DEFUN_DLD (rpElementAsComp, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpElementAsComp(@var{libHandle},@var{path})\n\
\n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpElementAsComp";

 ...
 *
 *    [retStr,err] = rpElementAsType(libHandle,path)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpElementAsType(libHandle,path)
...
DEFUN_DLD (rpElementAsType, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpElementAsType(@var{libHandle},@var{path})\n\
\n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpElementAsType";

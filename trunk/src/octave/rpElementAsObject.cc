 ...
 *
 *    [retStr,err] = rpElementAsObject(libHandle,path)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpElementAsObject(libHandle,path)
...
DEFUN_DLD (rpElementAsObject, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpElementAsObject(@var{libHandle},@var{path})\n\
\n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpElementAsObject";

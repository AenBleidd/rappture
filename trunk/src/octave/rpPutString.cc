 ...
 *
 *    [err] = rpPutString(libHandle,path,value,append)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [err] = rpPutString (libHandle,path,value,append)
...
DEFUN_DLD (rpPutString, args, ,
"-*- texinfo -*-\n\
[err] = rpPutString(@var{libHandle},@var{path},@var{value},@var{append})\n\
\n\
...
{
    static std::string who = "rpPutString";

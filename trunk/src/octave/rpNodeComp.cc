 ...
 *
 *    [retStr,err] = rpNodeComp(nodeHandle)
 *
 * ======================================================================
...
/**********************************************************************/
// METHOD: [retStr,err] = rpNodeComp(nodeHandle)
...
DEFUN_DLD (rpNodeComp, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpNodeComp(@var{nodeHandle})\n\
\n\
This method returns the component name of the node represented \n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpNodeComp";

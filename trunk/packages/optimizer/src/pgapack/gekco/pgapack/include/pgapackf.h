...
#ifndef __PGA_PACK_H_
#define __PGA_PACK_H_
...
#define PGA_USERFUNCTION_RANKING                 11
#define PGA_USERFUNCTION_FITNESS                 12
#define PGA_USERFUNCTION_SELECT                  13
#define PGA_USERFUNCTION_SORTPOP                 14

/******* EHW Modification ************************/
#define PGA_USERFUNCTION_SETTEMP                 15
#define PGA_USERFUNCTION_ENDOFREPFCN             16
#define PGA_USERFUNCTION_DESTROYUD               17

#define PGA_USERFUNCTION_INITUSERCTX             18
#define PGA_USERFUNCTION_KILLUSERCTX             19
#define PGA_NUM_USERFUNCTIONS                    19
/*************************************************/
...
/*****************  EHW Project Modifications  **********************/
  void   *UserData;                 /* pointer to circuit response         */
/********************************************************************/
} PGAIndividual;
...
/********************** EHW project modifications *********************/
    int sUD;                 /* Size of User Data array structure     */
/**********************************************************************/
} PGAAlgorithm;
...
/******************* DRH Mod for MMPAT ********************************/
    void         (*Rank)(PGAContext *, int); /* Calls a custom */
                                                   /*ranking function*/
    void         (*Fitness)(PGAContext *, int); /* Calls a custom fitness eval*/
    void         (*Select) (PGAContext *, int); /* Calls a custom selection */
/*********************************************/
/* new added by Lu Yang */
    void         (*SortPop) (PGAContext *, int); /* Calls a custom sort pop */
/*********************************************/
                                                /* function                 */
/*********************************************************************/

/********************** EHW project modifications *********************/
    void         (*SetTemp)(PGAContext *); /* Sets the Temperature    */
                                           /*  Parameter              */
/**********************************************************************/

/*** SNS Addition, it sets the reproductive flags *************/
/*** This may be part of The Chromosome User Data ************/

 /* Gets executed when  PGASetEvaluationUpToDateFlag  is called
      and the flag is set to PGA_FALSE  Is called so that the user
      data is updated whenever the Evaluation up to date flag is set to
      false 
   */
    void 	 (*EndOfRepFcn)(PGAContext *,int,int);

    void 	 (*DestroyUD)(PGAContext *,int,int);
   /* CHSL: Executed before the GA is run (gen 0) */
    void         (*InitUserCtx)(PGAContext *);
   /* CHSL: Executed after the GA is finished (end of last gen) */
    void         (*KillUserCtx)(PGAContext *);
...
typedef struct {
    ...
    void         (*EndOfGen)(void *);
/******************* DRH Mod for MMPAT ********************************/
    void         (*Rank)( void *, void *); /* calls a custom  */
                                                 /* ranking function*/
    void         (*Fitness)( void *, void *); /* Calls a custom fitness eval*/
    void         (*Select )( void *, void *); /* Calls a custom selection fn*/
/*********************************************/
/* new added by Lu Yang */
    void         (*SortPop) (void *, void *); /* Calls a custom sort pop */
/*********************************************************************/

/********************** EHW project modifications *********************/
    void         (*SetTemp)(void *);       /* Sets the Temperature    */
                                           /*  Parameter              */
/**********************************************************************/

/*** SNS Addition, it sets the reproductive flags *************/
/*** This may be part of The Chromosome User Data ************/
    void 	 (*EndOfRepFcn)(void *,void *,void *);
    void 	 (*DestroyUD)(void *,void *,void *);

  /* CHSL: Executed before the GA is run (gen 0) */
   void         (*InitUserCtx)(void *);
   /* CHSL: Executed after the GA is finished (end of last gen) */
   void         (*KillUserCtx)(void *);
...
void PGADestroyUD (PGAContext *ctx,int,int);

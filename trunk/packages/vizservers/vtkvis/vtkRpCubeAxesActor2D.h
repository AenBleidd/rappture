...
class VTK_HYBRID_EXPORT vtkRpCubeAxesActor2D : public vtkActor2D
{
public:
  vtkTypeMacro(vtkRpCubeAxesActor2D,vtkActor2D);
  ...
  // is set to 3.
  static vtkRpCubeAxesActor2D *New();
...
private:
  vtkRpCubeAxesActor2D(const vtkRpCubeAxesActor2D&);  // Not implemented.
  void operator=(const vtkRpCubeAxesActor2D&);  // Not implemented.
};

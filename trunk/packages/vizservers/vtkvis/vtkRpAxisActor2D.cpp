...
vtkStandardNewMacro(vtkRpAxisActor2D);

vtkCxxSetObjectMacro(vtkRpAxisActor2D,LabelTextProperty,vtkTextProperty);
vtkCxxSetObjectMacro(vtkRpAxisActor2D,TitleTextProperty,vtkTextProperty);

//----------------------------------------------------------------------------
// Instantiate this object.
vtkRpAxisActor2D::vtkRpAxisActor2D()
{
...
int vtkRpAxisActor2D::RenderOpaqueGeometry(vtkViewport *viewport)
{
...
int vtkRpAxisActor2D::RenderOverlay(vtkViewport *viewport)
{
  int i, renderedSomething=0;
...
int vtkRpAxisActor2D::HasTranslucentPolygonalGeometry()
{
  return 0;
}
...
void vtkRpAxisActor2D::ReleaseGraphicsResources(vtkWindow *win)
{
...
//----------------------------------------------------------------------------
void vtkRpAxisActor2D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkRpAxisActor2D::BuildAxis(vtkViewport *viewport)
{
...
//----------------------------------------------------------------------------
void vtkRpAxisActor2D::UpdateAdjustedRange()
{
...
int vtkRpAxisActor2DComputeTicks(double sRange[2], double &interval,
                               double &root)
{
...
//reasonable interval
void vtkRpAxisActor2D::ComputeRange(double inRange[2],
                                  double outRange[2],
                                  ...
                                  double &interval)
{
  ...
  double root;
  numTicks = vtkRpAxisActor2DComputeTicks(sRange, interval, root);
...
void vtkRpAxisActor2D::SetOffsetPosition(double xTick[3], double theta,
...
//----------------------------------------------------------------------------
double vtkRpAxisActor2D::ComputeStringOffset(double width, double height,
                                           double theta)
{
...
//----------------------------------------------------------------------------
void vtkRpAxisActor2D::ShallowCopy(vtkProp *prop)
{
  vtkRpAxisActor2D *a = vtkRpAxisActor2D::SafeDownCast(prop);
  if ( a != NULL )
    {

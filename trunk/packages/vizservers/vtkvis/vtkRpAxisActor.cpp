...
int vtkRpAxisActorMultiplierTable1[4] = { -1, -1, 1,  1};
int vtkRpAxisActorMultiplierTable2[4] = { -1,  1, 1, -1};
...
void vtkRpAxisActor::SetLabelPositions(vtkViewport *viewport, bool force)
{
  ...
  switch (this->AxisType)
    ...
    case VTK_AXIS_TYPE_Z :
      xmult = vtkRpAxisActorMultiplierTable1[this->AxisPosition];
      ymult = vtkRpAxisActorMultiplierTable2[this->AxisPosition];
      break;
    }
...
//
void vtkRpAxisActor::TransformBounds(vtkViewport *viewport, double bnds[6])
{
...
// *********************************************************************
void
vtkRpAxisActor::SetBounds(double b[6])
{
...
void vtkRpAxisActor::GetBounds(double b[6])
{
  for (int i = 0; i < 6; i++)
    {
    b[i] = this->Bounds[i];
...
vtkCoordinate* vtkRpAxisActor::GetPoint1Coordinate()
{

...
=========================================================================*/
// .NAME vtkRpAxisActor2D - Create an axis with tick marks and labels
// .SECTION Description
// vtkRpAxisActor2D creates an axis with tick marks, labels, and/or a title,
// depending on the particular instance variable settings. vtkRpAxisActor2D is
...
#ifndef __vtkRpAxisActor2D_h
#define __vtkRpAxisActor2D_h
...
class VTK_RENDERING_EXPORT vtkRpAxisActor2D : public vtkActor2D
{
public:
  vtkTypeMacro(vtkRpAxisActor2D,vtkActor2D);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Instantiate object.
  static vtkRpAxisActor2D *New();
...
private:
  vtkRpAxisActor2D(const vtkRpAxisActor2D&);  // Not implemented.
  void operator=(const vtkRpAxisActor2D&);  // Not implemented.
};

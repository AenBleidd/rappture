...
=========================================================================*/
// .NAME vtkRpCubeAxesActor - create a  plot of a bounding box edges -
// used for navigation
// .SECTION Description
// vtkRpCubeAxesActor is a composite actor that draws axes of the
...
// to render the vtkRpCubeAxesActor. You can optionally turn on/off labels,
...
private:
  ...
  void operator=(const vtkRpCubeAxesActor&); // Not implemented

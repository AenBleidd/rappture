...
itcl::class Rappture::PeriodicTable {
	...
	alkali_metal-activebackground			\#cd3434 
	alkali_metal-activeforeground			white 
	alkali_metal-disabledbackground			\#ff6666 
	alkali_metal-disabledforeground			\#D04747
	alkali_metal-background				\#ff6666 
	alkali_metal-foreground				black 
	alkaline_earth_metal-activebackground		\#cdac7b 
	alkaline_earth_metal-activeforeground		white 
	alkaline_earth_metal-disabledbackground		\#ffdead 
	alkaline_earth_metal-disabledforeground		\#C19A64
	alkaline_earth_metal-background			\#ffdead 
	alkaline_earth_metal-foreground			black 
	...
	noble_gas-activebackground			\#8ecdcd 
	noble_gas-activeforeground			white 
	noble_gas-disabledbackground			\#c0ffff 
	noble_gas-disabledforeground			\#7FC1C1
	noble_gas-background				\#c0ffff 
	noble_gas-foreground				black 
	other_non_metal-activebackground		\#6ecd6e 
	other_non_metal-activeforeground		white 
	other_non_metal-disabledbackground		\#a0ffa0 
	other_non_metal-disabledforeground		\#6ACD6A
	other_non_metal-background			\#a0ffa0 
	other_non_metal-foreground			black 
	post_transition_metal-activebackground		\#9a9a9a	
	post_transition_metal-activeforeground		white 
	post_transition_metal-disabledbackground	\#cccccc 
	post_transition_metal-disabledforeground	\#999999
	post_transition_metal-background		\#cccccc 
	post_transition_metal-foreground		black 
	transition_metal-activebackground		\#cd8e8e 
	transition_metal-activeforeground		white 
	transition_metal-disabledbackground		\#ffc0c0 
	transition_metal-disabledforeground		\#C77E7E
	transition_metal-background			\#ffc0c0 
	transition_metal-foreground			black 

...
void TransferFunctionGLUTWindow::sortPoints(){
	if (tf_numOfPoints==0)
		return;
...
ControlPoint* TransferFunctionGLUTWindow::addPoint(double x, double y){
...
void TransferFunctionGLUTWindow::removePoint(void* ptr){
	if (tf_numOfPoints==0)
		return;
...
ControlPoint* TransferFunctionGLUTWindow::boundaryChecking(){
...
void TransferFunctionGLUTWindow::scalePointsY(int offset){
	if (tf_numOfPoints<2)
		return;
...
void TransferFunctionGLUTWindow::scalePointsX(){
	ControlPoint* cur=tf_pointList;
	while (cur!=0){
...
void TransferFunctionGLUTWindow::dumpHist(){
/*
...
void TransferFunctionGLUTWindow::readHist(){
/*
...
void TransferFunctionGLUTWindow::plotHist(){

 ...
 *
 *    [retStr,err] = rpLibElementAsComp(libHandle,path)
 *
 * ======================================================================
...
DEFUN_DLD (rpLibElementAsComp, args, ,
"-*- texinfo -*-\n\
[retStr,err] = rpLibElementAsComp(@var{libHandle},@var{path})\n\
\n\
...
Error code, err=0 on success, anything else is failure.")
{
    static std::string who = "rpLibElementAsComp";

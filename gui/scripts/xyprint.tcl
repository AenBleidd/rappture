...
itcl::class Rappture::XyPrint {
    ...
    private method FixGraph {}
    private method FixLegend {}
    private method FixAxis {}
    private method FixElement {}
    private method FixLayout {}
...
# CONSTRUCTOR
# ----------------------------------------------------------------------
itcl::body Rappture::XyPrint::constructor { graph args } {
...
#     pack propagate $itk_component(hull) no
    ...
    update idletasks
    update
    puts stderr [$itk_component(tabs).layout_page.width configure ]

    puts stderr "interior size = [winfo width $itk_interior] [winfo height $itk_interior]"
    puts stderr "interior reqsize = [winfo reqwidth $itk_interior] [winfo reqheight $itk_interior]"
    puts stderr "size = [winfo width $itk_component(tabs)] [winfo height $itk_component(tabs)]"
    puts stderr "reqsize = [winfo reqwidth $itk_component(tabs)] [winfo reqheight $itk_component(tabs)]"
    puts stderr "graph size = [winfo width $itk_component(tabs).graph_page] [winfo height $itk_component(tabs).graph_page]"
    puts stderr "graph reqsize = [winfo reqwidth $itk_component(tabs).graph_page] [winfo reqheight $itk_component(tabs).graph_page]"
    puts stderr "legend size = [winfo width $itk_component(tabs).legend_page] [winfo height $itk_component(tabs).legend_page]"
    puts stderr "legend reqsize = [winfo reqwidth $itk_component(tabs).legend_page] [winfo reqheight $itk_component(tabs).legend_page]"
    puts stderr "axis size = [winfo width $itk_component(tabs).axis_page] [winfo height $itk_component(tabs).axis_page]"
    puts stderr "axis reqsize = [winfo reqwidth $itk_component(tabs).axis_page] [winfo reqheight $itk_component(tabs).axis_page]"
    eval itk_initialize $args
    after 1000 [itcl::code $this RegeneratePreview]
}
...
itcl::body Rappture::XyPrint::download {} {
...
itcl::body Rappture::XyPrint::FixGraph {} {
    RegeneratePreview
}

itcl::body Rappture::XyPrint::BuildGraphTab {} {
    ...
    bind $page.format <<Value>> [itcl::code $this FixGraph]
	...
	"ieee" "IEEE Journal"  \
	"gekco" "G Klimeck"  
    bind $page.style <<Value>> [itcl::code $this FixGraph]

    checkbutton $page.remember -text "remember settings" \
	-variable [itcl::scope _settings($this-graph-remember)]  
    ...
    set _settings($this-graph-format) eps
    set _settings($this-graph-style) ieee
    set _settings($this-graph-remember) 1
    $page.format value [$page.format label $_settings($this-graph-format)]
    $page.style value [$page.style label $_settings($this-graph-style)]
}
    
itcl::body Rappture::XyPrint::FixLegend {} {
...
itcl::body Rappture::XyPrint::BuildLegendTab {} {
	...
	-command [itcl::code $this FixLegend] 
    ...
    bind $page.position <<Value>> [itcl::code $this FixLegend]
	...
	"e" "east"  \
	"w" "west"  
    bind $page.anchor <<Value>> [itcl::code $this FixLegend]
	...
	-command [itcl::code $this FixElement]
    ...
    bind  $page.label <KeyPress-Return> [itcl::code $this FixElement]
	...
	"#a2cd5a" "dark olive green" \
        "#cd9b9b" "rosy brown"
    bind $page.color <<Value>> [itcl::code $this FixElement]
	...
	"" "solid"  \
        ...
        "2 4 2" "dashdot" \
        "2 4 2 2" "dashdotdot"
    bind $page.dashes <<Value>> [itcl::code $this FixElement]
	...
	"scross" "skinny cross" \
	"triangle" "triangle"
    bind $page.symbol <<Value>> [itcl::code $this FixElement]
    ...
    set _settings($this-legend-borderwidth) 1
...
itcl::body Rappture::XyPrint::FixAxis {} {
...
itcl::body Rappture::XyPrint::BuildAxisTab {} {
    ...
    $itk_component(axis_combo) value [lindex $names 0]
    blt::table configure $page r* -resize none
...
itcl::body Rappture::XyPrint::FixElement {} {
    set index [$itk_component(element_slider) get]
    set elem $_settings($this-element-$index)
    set page $itk_component(legend_page)
...
itcl::body Rappture::XyPrint::FixLayout {} {
...
itcl::body Rappture::XyPrint::BuildLayoutTab {} {
    ...
    bind  $page.width <KeyPress-Return> [itcl::code $this FixLayout]

    label $page.height_l -text "height" 
    entry $page.height -width 6 \
	-textvariable [itcl::scope _settings($this-layout-height)]
    bind  $page.height <KeyPress-Return> [itcl::code $this FixLayout]

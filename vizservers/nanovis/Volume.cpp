...
/* FIXME: Virtually all of the following methods could be inlined. */
void Volume::enable() { 
    enabled = true; 
}
void Volume::disable() { 
...
void Volume::move(Vector3 _loc) { 
    location = _loc; 
}
bool Volume::is_enabled() { 
    return enabled; 
}
Vector3* Volume::get_location() { 
    return &location; 
}
...
void Volume::set_n_slice(int n) { 
    n_slice = n; 
}
int Volume::get_n_slice() { 
    return n_slice; 
}
...
float Volume::get_specular() { 
    return specular; 
}
float Volume::get_diffuse() { 
    return diffuse; 
}
float Volume::get_opacity_scale() { 
    return opacity_scale; 
}
void Volume::set_specular(float s) { 
    specular = s; 
}
void Volume::set_diffuse(float d) { 
    diffuse = d; 
}
void Volume::set_opacity_scale(float s) { 
    opacity_scale = s; 
}

void Volume::enable_data() { 
    data_enabled = true; 
}
void Volume::disable_data() { 
    data_enabled = false; 
}
bool Volume::data_is_enabled() { 
    return data_enabled; 
}
void Volume::enable_outline() { 
    outline_enabled = true; 
}
void Volume::disable_outline() { 
    outline_enabled = false; 
}
bool Volume::outline_is_enabled() { 
...
void Volume::set_label(int axis, const char* txt){
    label[axis] = txt;
}

...
// ****************************************************************************
//  Method: vtkRpCubeAxesActor::AdjustValues
//
//  Purpose:
...
// ****************************************************************************
//  Method: vtkRpCubeAxesActor::AdjustRange
//
//  Purpose:
...
int vtkRpCubeAxesActor::LabelExponent(double min, double max)
{
  if (min == max)
    {
    return 0;
...
// *************************************************************************
//  Sends attributes to each vtkRpAxisActor.  Only sets those that are
...
//
static int vtkRpCubeAxesActorTriads[8][3] = {
  {mm,mm,mm}, {mm,Xm,Xm}, {Xm,mm,mX}, {Xm,Xm,XX},
  {mX,mX,mm}, {mX,XX,Xm}, {XX,mX,mX}, {XX,XX,XX}};
static int vtkRpCubeAxesActorConn[8][3] = {{1,2,4}, {0,3,5}, {3,0,6}, {2,1,7},
...
// *******************************************************************
// Method: vtkRpCubeAxesActor::AdjustTicksComputeRange
//

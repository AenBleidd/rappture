...
public :
	 ...
	 */
	void setPixels(COLORFORMAT format, DATATYPE type, int width, int height, void* data);
	 ...
	 * @param data texture data
	 */
	void setPixels(TEXTARGET target, COLORFORMAT internalFormat, COLORFORMAT format, DATATYPE type, int width, int height, void* data);
	 ...
	 * @param data texture data
	 */
	void setPixels(COLORFORMAT internalFormat, COLORFORMAT format, DATATYPE type, int width, int height, void* data);

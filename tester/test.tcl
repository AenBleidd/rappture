...
itcl::body Rappture::Tester::Test::regoldenize {} {
    ...
    set oldlib [Rappture::library $_testxml]
    set newlib [Rappture::library $_runfile]
...
itcl::body Rappture::Tester::Test::run {} {
    ...
    if {$status == 0 && [Rappture::library isvalid $result]} {
        ...
        set _diffs [diffs $golden $result]
        set _missing [missing $golden $result]
        set _added [added $golden $result]
...
itcl::body Rappture::Tester::Test::makeDriver {} {
    ...
    return [merge $toolobj $golden $driver]
}
